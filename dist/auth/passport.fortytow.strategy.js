...
let FortyTwoStrategy = class FortyTwoStrategy extends (0, passport_1.PassportStrategy)(Strategy, 'FortyTwo') {
    constructor(AuthService) {
        super({
            ...
            callbackURL: 'http://localhost:3009/auth/FortyTwo/callback',
            scope: ['public'],
        });
...
//# sourceMappingURL=passport.fortytow.strategy.js.map